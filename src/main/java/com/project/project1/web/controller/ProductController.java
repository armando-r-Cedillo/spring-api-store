package com.project.project1.web.controller;

import com.project.project1.domain.Product;
import com.project.project1.domain.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> getAll() {
        System.out.println("modificado imprecion del getAll");
